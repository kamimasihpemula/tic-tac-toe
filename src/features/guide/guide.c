...
void guide()
{
    ...
    printf("   | 3. Berikutnya, pemain diminta untuk memasukkan nama/      |\n");
    printf("   |    username dengan menginputkan sebuah nama berupa string/|\n");
    printf("   |    kumpulan huruf                                         |\n");
    printf("   | 4. Setelah memasukkan nama, pemain akan melihat           |\n");
    ...
    printf("   |    tekan enter.                                           |\n");
    printf("   | 5. Selanjutnya akan muncul tulisan 'Enter column (1-x) ; '|\n");
    ...
    printf("   | 6. Berikutnya, akan muncul tampilan papan berisi simbol X |\n");
    printf("   |    yang berada di tempat  pemain tentukan. Serta simbol O |\n");
    printf("   |    dari computer.                                         |\n");
    printf("   | 7. Ulangi langkah 4 sampai 5, hingga pemain menang ataupun|\n");
    printf("   |    kalah.                                                 |\n");
    printf("   '-----------------------------------------------------------'\n\n");
    printf("   .-----------------------------------------------------------.\n");
    printf("   |                        *Multiplayer*                      |\n");
    ...
    printf("   |    pemain bisa menginputkan '7' bila pemain ingin bermain |\n");
    printf("   |    pada papan 7 x 7.                                      |\n");
    printf("   | 2. Berikutnya, pemain 1 diminta untuk menginputkan nama,  |\n");
    printf("   |    dilanjutkan dengan pemain 2. Pemain menginputkan       |\n");
    printf("   |    nama berupa string/kumpulan huruf.                     |\n");
    printf("   | 3. Setelah memasukkan nama, pemain 1 akan melihat         |\n");
    printf("   |    sebuah papan yang kosong. Lalu akan ada tulisan 'Enter |\n");
    ...
    printf("   |    enter.                                                 |\n");
    printf("   | 5. Untuk giliran Pemain 2 dapat mengikuti langkah 2-3.    |\n");
    printf("   | 6. Ulangi langkah 2-4 , hingga salah satu dari kedua      |\n");
